...
import com.firefishcomms.library.activities.ImageEditingActivity;
...
public class SelectedImagesAdapter extends RecyclerView.Adapter<SelectedImagesAdapter.SelectedImageViewHolder> {
    ...
    public class SelectedImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(Constants.EXTRA_SELECTED_IMAGE_FILE, selectedImagesItem.imageFile);
            intent.putExtra(Constants.EXTRA_ACTIVITY_REQUEST_CODE, RequestCode.IMAGE_EDIT_GET_FILTER);

            activity.startActivityForResult(intent, RequestCode.IMAGE_EDIT_GET_FILTER);
        }
    }
